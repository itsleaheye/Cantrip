...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(tabs)` | `/(tabs)\CharacterList` | `/..\components\CharacterListItem\CharacterListItem` | `/..\components\CharacterListItem\styles` | `/..\components\GradientButton` | `/..\db\CantripDatabase` | `/..\db\queries\abilitiesQuery` | `/..\db\queries\backgroundQuery` | `/..\db\queries\characterClassesQuery` | `/..\db\queries\characterQuery` | `/..\db\queries\languagesQuery` | `/..\db\queries\racesQuery` | `/..\db\queries\skillsQuery` | `/..\db\queries\spellsQuery` | `/..\types\Character` | `/..\types\placeholderCharacters` | `/_sitemap` | `/explore`;
