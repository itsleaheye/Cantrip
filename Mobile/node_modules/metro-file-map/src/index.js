...
class HasteMap extends _events.default {
    ...
    if (!this._buildPromise) {
      this._buildPromise = (async () => {
        ...
        await this._takeSnapshotAndPersist(
          fileSystem,
          (_fileDelta$clocks = fileDelta.clocks) !== null &&
            _fileDelta$clocks !== void 0
            ? _fileDelta$clocks
            : new Map(),
          rawModuleMap,
   ...
   */
  async read() {
    var _this$_startupPerfLog5, _this$_startupPerfLog7;
    let data;
   ...
   * 3. parse and extract metadata from changed files.
   */
  _processFile(fileSystem, moduleMap, filePath, workerOptions) {
    const rootDir = this._options.rootDir;
  ...
  _applyFileDelta(fileSystem, moduleMap, delta) {
    var _this$_startupPerfLog10,
      _this$_startupPerfLog11,
      _this$_startupPerfLog12,
      _this$_startupPerfLog13,
      _this$_startupPerfLog14,
      _this$_startupPerfLog15;
    ...
    _this$_startupPerfLog11 === void 0
      ? void 0
      : _this$_startupPerfLog11.point("applyFileDelta_addRemove_start");
    ...
    _this$_startupPerfLog12 === void 0
      ? void 0
      : _this$_startupPerfLog12.point("applyFileDelta_addRemove_end");
    (_this$_startupPerfLog13 = this._startupPerfLogger) === null ||
    _this$_startupPerfLog13 === void 0
      ? void 0
      : _this$_startupPerfLog13.point("applyFileDelta_preprocess_start");
    const promises = [];
    ...
    _this$_startupPerfLog14 === void 0
      ? void 0
      : _this$_startupPerfLog14.point("applyFileDelta_preprocess_end");
    ...
    _this$_startupPerfLog15 === void 0
      ? void 0
      : _this$_startupPerfLog15.point("applyFileDelta_process_start");
    return Promise.all(promises).then(
      () => {
        var _this$_startupPerfLog16, _this$_startupPerfLog17;
        this._cleanup();
        (_this$_startupPerfLog16 = this._startupPerfLogger) === null ||
        _this$_startupPerfLog16 === void 0
          ? void 0
          : _this$_startupPerfLog16.point("applyFileDelta_process_end");
        (_this$_startupPerfLog17 = this._startupPerfLogger) === null ||
        _this$_startupPerfLog17 === void 0
          ? void 0
          : _this$_startupPerfLog17.point("applyFileDelta_end");
      },
      (error) => {
        this._cleanup();
        throw error;
  ...
  async _takeSnapshotAndPersist(
    ...
    var _this$_startupPerfLog18, _this$_startupPerfLog19;
    (_this$_startupPerfLog18 = this._startupPerfLogger) === null ||
    _this$_startupPerfLog18 === void 0
      ? void 0
      : _this$_startupPerfLog18.point("persist_start");
    ...
    (_this$_startupPerfLog19 = this._startupPerfLogger) === null ||
    _this$_startupPerfLog19 === void 0
      ? void 0
      : _this$_startupPerfLog19.point("persist_end");
  }
  ...
  async _watch(fileSystem, moduleMap) {
    var _this$_startupPerfLog20, _this$_startupPerfLog22;
    (_this$_startupPerfLog20 = this._startupPerfLogger) === null ||
    _this$_startupPerfLog20 === void 0
      ? void 0
      : _this$_startupPerfLog20.point("watch_start");
    if (!this._options.watch) {
      var _this$_startupPerfLog21;
      (_this$_startupPerfLog21 = this._startupPerfLogger) === null ||
      _this$_startupPerfLog21 === void 0
        ? void 0
        : _this$_startupPerfLog21.point("watch_end");
      return;
    }
    ...
    (_this$_startupPerfLog22 = this._startupPerfLogger) === null ||
    _this$_startupPerfLog22 === void 0
      ? void 0
      : _this$_startupPerfLog22.point("watch_end");
  }
  ...
  async _shouldUseWatchman() {
    ...
    if (!this._canUseWatchmanPromise) {
      this._canUseWatchmanPromise = (0, _checkWatchmanCapabilities.default)(
        ...
        .then(() => true)
        .catch((e) => {
          var _this$_startupPerfLog23, _e$message;
          // TODO: Advise people to either install Watchman or set
          // `useWatchman: false` here?
          (_this$_startupPerfLog23 = this._startupPerfLogger) === null ||
          _this$_startupPerfLog23 === void 0
            ? void 0
            : _this$_startupPerfLog23.annotate({
                string: {
