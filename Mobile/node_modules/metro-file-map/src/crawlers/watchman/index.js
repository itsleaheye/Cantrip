            ...
            watchmanRoots.set(response.watch, {
              ...
              directoryFilters: (
                (existing === null || existing === void 0
                  ? void 0
                  : existing.directoryFilters) || []
              ).concat(response.relative_path),
            });
          } else {
      ...
      Array.from(rootProjectDirMappings).map(
        async ([root, { directoryFilters, watcher }], index) => {
          ...
          perfLogger === null || perfLogger === void 0
            ...
            : perfLogger.annotate({
                string: {
                  [`watchmanCrawl/query_${index}_watcher`]:
                    watcher !== null && watcher !== void 0
                      ? watcher
                      : "unknown",
  ...
  for (const [watchRoot, response] of results) {
    ...
    for (const fileData of response.files) {
      ...
      if (!fileData.exists) {
        ...
        let symlinkInfo = 0;
        if (fileData.type === "l") {
          var _fileData$symlink_tar;
          symlinkInfo =
            (_fileData$symlink_tar = fileData["symlink_target"]) !== null &&
            _fileData$symlink_tar !== void 0
              ? _fileData$symlink_tar
              : 1;
        }
        let nextData = [
          "",
